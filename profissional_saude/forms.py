...
class AtendimentoProfissionalForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['chamar'] = forms.BooleanField(required=False, widget=forms.HiddenInput())
        self.fields['reanunciar'] = forms.BooleanField(required=False, widget=forms.HiddenInput())
        self.fields['encaminhar'] = forms.BooleanField(required=False, widget=forms.HiddenInput())
        self.fields['confirmar'] = forms.BooleanField(required=False, widget=forms.HiddenInput())
    ...
    def clean(self):
        ...
        if cleaned_data.get('chamar'):
            if acao_selecionada:
                raise forms.ValidationError("Selecione apenas uma ação (Chamar, Reanunciar, Encaminhar, Confirmar).")
