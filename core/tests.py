...
from .models import (
	CustomUser, Paciente, Atendimento, RegistroDeAcesso, Guiche, Chamada, ChamadaProfissional
)
from .forms import CadastrarPacienteForm, CadastrarFuncionarioForm, LoginForm
